  ...
  return (
    <>
      ...
      >
        <nav className="flex flex-col px-5">
          {NAV_LINKS.map((link) => (
            <a
              ...
              className="flex items-center justify-between font-display text-olive text-2xl py-4 border-b border-sand/60 hover:text-terracotta active:text-terracotta transition-colors"
            >
              {link.label}
        ...
        {/* CTA rápido dentro del menú */}
        <div className="px-5 mt-7">
          <a
            href="#contact"
            onClick={(e) => handleLinkClick(e, '#contact')}
            className="block w-full text-center bg-terracotta text-offwhite font-body font-medium py-4 rounded-full text-base hover:bg-terracotta/90 active:scale-95 transition-all duration-200"
          >
